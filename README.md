...
└── link_hub/            # Static landing page (deploy to GitHub/Cloudflare Pages)
    └── index.html
```
...
| GitHub Pages | Free | Link hub hosting |
...
- **link_hub/** - High-converting dark-theme landing page. Deploy free to GitHub Pages or Cloudflare Pages.
...
Add a .gitignore to never commit your .env file.
